            ...
            <tbody>
                @foreach ($students as $student)
                    @foreach ($events as $event)
                        @if ($student->id_evento == $event->id && $student->progreso == 'enviado')
                        <tr>
                            <td>{{$student->id}}</td>
                            ...
                            <td>
                                <br> Editar: 
                                <a href="{{route('admin.students.enviado.edit', $student)}}" class="btn btn-outline-primary">
                                ...
                                <br><br>
                                <form action="{{route('admin.students.enviado.destroy', $student)}}" method="POST">
                                    @method('delete')
                                    @csrf
                                    Eliminar:
