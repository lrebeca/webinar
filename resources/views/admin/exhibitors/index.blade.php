...
{{-- Este es para que se muestre el mensaje  --}}
    ...
    @endif
<div class="car">
    Estas provincias o ciudades son pertenecientes al pais de Bolivia
</div>

<div class="card-header">
    <a href="{{route('admin.exhibitors.create')}}" class="btn btn-primary">Agregar Un Nuevo expositor</a>
</div><br>
<div class="car">
    <div class="car-body">
        <table id="provinces" class="table dt-responsive nowrap table-striped">
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>
                            <form action="{{route('admin.exhibitors.destroy', $exhibitor)}}" method="POST">
                                @method('delete')
                                @csrf
