...
@section('content')
    ...
    <div class="card-header">
            <a href="{{route('admin.documents.create')}}" class="btn btn-primary">Subir un Documento</a>
    </div>
        <br>
                ...
                <tbody>
                    @foreach ($events as $event)
                        @foreach ($documents as $document)
                            @if ($event->id == $document->id_evento)
                                <tr>
                                    <td>{{$document->id}}</td>
                                    <td>{{$event->evento}}</td>
                                    ...
                                    <td>
                                        <br> Editar: 
                                        <a href="{{route('admin.documents.edit', $document)}}" class="btn btn-outline-primary">
