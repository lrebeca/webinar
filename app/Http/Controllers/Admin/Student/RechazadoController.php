...
class RechazadoController extends Controller
{
    /**
    ...
    public function index()
    {
       ...
       // return $students;
        ...
        return view('admin.students.rechazado', compact('students', 'events'));
    }
    ...
    public function update(StudentRequest $request, Student $student)
    {
        ...
        return redirect()->route('admin.students.rechazado.edit', $student)->with('info','Se modificaron los datos del participante');
    }
